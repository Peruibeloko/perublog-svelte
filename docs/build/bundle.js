...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 10, 4, 161);
    			attr_dev(h1, "class", "svelte-uq40xc");
    			add_location(h1, file$4, 9, 2, 151);
    			add_location(br, file$4, 13, 28, 240);
    			attr_dev(h2, "class", "svelte-uq40xc");
    			add_location(h2, file$4, 12, 2, 206);
    			attr_dev(div, "id", "hamb");
    			attr_dev(div, "class", "svelte-uq40xc");
    			add_location(div, file$4, 16, 2, 293);
    			attr_dev(header, "class", "svelte-uq40xc");
    			add_location(header, file$4, 8, 0, 139);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*openMobileSocials*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ isSidebarOpen, openMobileSocials });
    	return [openMobileSocials];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "click", /*closeMobileSocials*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*sidebarState*/ 1 && aside_class_value !== (aside_class_value = "" + (null_to_empty(/*sidebarState*/ ctx[0]) + " svelte-nxnnh8"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	isSidebarOpen.subscribe(value => {
    		$$invalidate(0, sidebarState = value ? "active" : "");
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("sidebarState" in $$props) $$invalidate(0, sidebarState = $$props.sidebarState);
    	};
    	...
    	return [sidebarState, closeMobileSocials];
    }
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function hashChangeHandler() {
    		...
    		const fetchData = await fetch(`${"https://perublog.herokuapp.com"}/post/${postNum || postCount}`);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 63, 6, 1336);
    			attr_dev(li0, "class", "svelte-3pvkcl");
    			add_location(li0, file$1, 62, 4, 1325);
    			...
    			add_location(button3, file$1, 84, 6, 1879);
    			attr_dev(li3, "class", "svelte-3pvkcl");
    			add_location(li3, file$1, 83, 4, 1868);
    			...
    			add_location(button4, file$1, 93, 6, 2093);
    			attr_dev(li4, "class", "svelte-3pvkcl");
    			add_location(li4, file$1, 92, 4, 2082);
    			attr_dev(ul, "class", "svelte-3pvkcl");
    			add_location(ul, file$1, 61, 2, 1316);
    			attr_dev(nav, "id", "navlist");
    			attr_dev(nav, "class", "svelte-3pvkcl");
    			add_location(nav, file$1, 60, 0, 1295);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
